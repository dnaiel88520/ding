...
public class teasoup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teasoup);

        final RequestQueue queue = Volley.newRequestQueue(this);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("茶湯會");
        drinkList = new ArrayList<>();
        recyclerView =findViewById(R.id.teasoup);
        String name ="茶湯會";
        jsonrequest();
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(teasoup.this);
